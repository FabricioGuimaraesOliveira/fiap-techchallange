...
public class BeanConfiguration {
	...
	@Bean
	public ClienteCpfGateway createClienteCpfGateway(DynamoDbEnhancedClient enhancedClient,
	...
	@Bean
	PedidoUseCase createPedidoUseCase(PedidoGateway pedidoGateway, ProdutoGateway produtoGateway,
